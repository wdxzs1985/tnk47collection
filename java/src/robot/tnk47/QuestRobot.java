...
import robot.tnk47.battle.BattleInviteHandler;
import robot.tnk47.battle.BattleResultHandler;
import robot.tnk47.battle.BattleSupportHandler;
...
public class QuestRobot extends AbstractRobot {
    ...
    public QuestRobot(final String config) {
        ...
        this.registerHandler("/battle/battle-invite",
                             new BattleInviteHandler(this));
        this.registerHandler("/battle/battle-support",
                             new BattleSupportHandler(this));
